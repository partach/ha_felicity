_REGISTERS_TREX_FIFTY = {
    ...
    "phase_a_grid_power_factor": {'address': 4485, 'name': 'Phase A Grid Power Factor (0.01)', 'precision': 2, 'index': 3, 'device_class': 'power_factor', 'state_class': 'measurement'},  # Custom: power_factor
    "phase_b_grid_power_factor": {'address': 4486, 'name': 'Phase B Grid Power Factor (0.01)', 'precision': 2, 'index': 3, 'device_class': 'power_factor', 'state_class': 'measurement'},
    "phase_c_grid_power_factor": {'address': 4487, 'name': 'Phase C Grid Power Factor (0.01)', 'precision': 2, 'index': 3, 'device_class': 'power_factor', 'state_class': 'measurement'},
    "phase_a_inverter_power_factor": {'address': 4488, 'name': 'Phase A inverter power factor (0.01)', 'precision': 2, 'index': 3, 'device_class': 'power_factor', 'state_class': 'measurement'},
    "phase_b_inverter_power_factor": {'address': 4489, 'name': 'Phase B inverter power factor (0.01)', 'precision': 2, 'index': 3, 'device_class': 'power_factor', 'state_class': 'measurement'},
    "phase_c_inverter_power_factor": {'address': 4490, 'name': 'Phase C inverter power factor (0.01)', 'precision': 2, 'index': 3, 'device_class': 'power_factor', 'state_class': 'measurement'},
    "microinverter_total_energy_high": {'address': 4492, 'name': 'Microinverter Total Energy High （0.1KWh）', 'precision': 1, 'index': 8, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "microinverter_total_energy_low": {'address': 4493, 'name': 'Microinverter Total Energy Low （0.1KWh）', 'precision': 1, 'index': 8, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    ...
    "pv1_month_energy_high": {'address': 4530, 'name': 'PV1 Month Energy High（0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "pv1_month_energy_low": {'address': 4531, 'name': 'PV1 Month Energy Low（0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    "pv1_year_energy_high": {'address': 4532, 'name': 'PV1 Year Energy High（0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "pv1_year_energy_low": {'address': 4533, 'name': 'PV1 Year Energy Low（0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    ...
    "pv2_month_energy_high": {'address': 4535, 'name': 'PV2 Month Energy High（0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "pv2_month_energy_low": {'address': 4536, 'name': 'PV2 Month Energy Low（0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    "pv2_year_energy_high": {'address': 4537, 'name': 'PV2 Year Energy High（0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "pv2_year_energy_low": {'address': 4538, 'name': 'PV2 Year Energy Low（0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    ...
    "pv3_month_energy_high": {'address': 4540, 'name': 'PV3 Month Energy High（0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "pv3_month_energy_low": {'address': 4541, 'name': 'PV3 Month Energy Low（0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    "pv3_year_energy_high": {'address': 4542, 'name': 'PV3 Year Energy High（0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "pv3_year_energy_low": {'address': 4543, 'name': 'PV3 Year Energy Low（0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    ...
    "pv4_month_energy_high": {'address': 4545, 'name': 'PV4 Month Energy High（0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "pv4_month_energy_low": {'address': 4546, 'name': 'PV4 Month Energy Low（0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    "pv4_year_energy_high": {'address': 4547, 'name': 'PV4 Year Energy High（0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "pv4_year_energy_low": {'address': 4548, 'name': 'PV4 Year Energy Low（0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    ...
    "bat1_month_charge_energy_high": {'address': 4552, 'name': 'Bat1 Month Charge Energy High （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "bat1_month_charge_energy_low": {'address': 4553, 'name': 'Bat1 Month Charge Energy Low （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    "bat1_year_charge_energy_high": {'address': 4554, 'name': 'Bat1 Year Charge Energy High （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "bat1_year_charge_energy_low": {'address': 4555, 'name': 'Bat1 Year Charge Energy Low （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    ...
    "bat1_month_discharge_energy_high": {'address': 4557, 'name': 'Bat1 Month Discharge Energy High （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "bat1_month_discharge_energy_low": {'address': 4558, 'name': 'Bat1 Month Discharge Energy Low （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    "bat1_year_discharge_energy_high": {'address': 4559, 'name': 'Bat1 Year Discharge Energy High （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "bat1_year_discharge_energy_low": {'address': 4560, 'name': 'Bat1 Year Discharge Energy Low （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    ...
    "bat2_month_charge_energy_high": {'address': 4562, 'name': 'BAT2 Month Charge Energy High （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "bat2_month_charge_energy_low": {'address': 4563, 'name': 'BAT2 Month Charge Energy Low （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    "bat2_year_charge_energy_high": {'address': 4564, 'name': 'BAT2 Year Charge Energy High （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "bat2_year_charge_energy_low": {'address': 4565, 'name': 'BAT2 Year Charge Energy Low （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    ...
    "bat2_month_discharge_energy_high": {'address': 4567, 'name': 'BAT2 Month Discharge Energy High （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "bat2_month_discharge_energy_low": {'address': 4568, 'name': 'BAT2 Month Discharge Energy Low （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    "bat2_year_discharge_energy_high": {'address': 4569, 'name': 'BAT2 Year Discharge Energy High （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "bat2_year_discharge_energy_low": {'address': 4570, 'name': 'BAT2 Year Discharge Energy Low （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    ...
    "grid_month_cost_energy_high": {'address': 4572, 'name': 'Grid Month Cost Energy High （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "grid_month_cost_energy_low": {'address': 4573, 'name': 'Grid Month Cost Energy Low （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    "grid_year_cost_energy_high": {'address': 4574, 'name': 'Grid Year Cost Energy High （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "grid_year_cost_energy_low": {'address': 4575, 'name': 'Grid Year Cost Energy Low （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    ...
    "grid_month_feed_energy_high": {'address': 4577, 'name': 'Grid Month Feed Energy High （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "grid_month_feed_energy_low": {'address': 4578, 'name': 'Grid Month Feed Energy Low （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    "grid_year_feed_energy_high": {'address': 4579, 'name': 'Grid Year Feed Energy High （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "grid_year_feed_energy_low": {'address': 4580, 'name': 'Grid Year Feed Energy Low （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    ...
    "load_month_cost_energy_high": {'address': 4582, 'name': 'Load Month Cost Energy High （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "load_month_cost_energy_low": {'address': 4583, 'name': 'Load Month Cost Energy Low （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    "load_year_cost_energy_high": {'address': 4584, 'name': 'Load Year Cost Energy High （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "load_year_cost_energy_low": {'address': 4585, 'name': 'Load Year Cost Energy Low （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    ...
    "generator_month_cost_energy_high": {'address': 4587, 'name': 'Generator Month Cost Energy High （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "generator_month_cost_energy_low": {'address': 4588, 'name': 'Generator Month Cost Energy Low （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    "generator_year_cost_energy_high": {'address': 4589, 'name': 'Generator Year Cost Energy High （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "generator_year_cost_energy_low": {'address': 4590, 'name': 'Generator Year Cost Energy Low （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    ...
    "microinverter_month_cost_energy_high": {'address': 4592, 'name': 'Microinverter Month Cost Energy High （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "microinverter_month_cost_energy_low": {'address': 4593, 'name': 'Microinverter Month Cost Energy Low （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    "microinverter_year_cost_energy_high": {'address': 4594, 'name': 'Microinverter Year Cost Energy High （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "microinverter_year_cost_energy_low": {'address': 4595, 'name': 'Microinverter Year Cost Energy Low （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    ...
    "homeload_month_cost_energy_high": {'address': 4597, 'name': 'Homeload Month Cost Energy High （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "homeload_month_cost_energy_low": {'address': 4598, 'name': 'Homeload Month Cost Energy Low （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    "homeload_year_cost_energy_high": {'address': 4599, 'name': 'Homeload Year Cost Energy High （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing', 'size': 2, 'endian': 'big'},
    "homeload_year_cost_energy_low": {'address': 4600, 'name': 'Homeload Year Cost Energy Low （0.1KWh）', 'precision': 1, 'index': 1, 'unit': 'kWh', 'device_class': 'energy', 'state_class': 'total_increasing'},
    ...
    "econ_rule_1_start_time": {'address': 8715, 'name': 'ECO1_start_time', 'precision': 0, 'index': 99, 'type': 'time', 'state_class': 'measurement'},
    "econ_rule_1_stop_time": {'address': 8716, 'name': 'ECO1_stop_time', 'precision': 0, 'index': 99, 'type': 'time', 'state_class': 'measurement'},
    "econ_rule_1_volt": {'address': 8717, 'name': 'ECO1_Volt', 'precision': 1, 'index': 1, 'unit': 'V', 'device_class': 'voltage', 'state_class': 'measurement'},
    ...
    "econ_rule_2_start_time": {'address': 8722, 'name': 'ECO2_start_time', 'precision': 0, 'index': 99, 'type': 'time', 'state_class': 'measurement'},
    "econ_rule_2_stop_time": {'address': 8723, 'name': 'ECO2_stop_time', 'precision': 0, 'index': 99, 'type': 'time', 'state_class': 'measurement'},
    "econ_rule_2_volt": {'address': 8724, 'name': 'ECO2_Volt', 'precision': 1, 'index': 1, 'unit': 'V', 'device_class': 'voltage', 'state_class': 'measurement'},
    ...
    "econ_rule_3_start_time": {'address': 8729, 'name': 'ECO3_start_time', 'precision': 0, 'index': 99, 'type': 'time', 'state_class': 'measurement'},
    "econ_rule_3_stop_time": {'address': 8730, 'name': 'ECO3_stop_time', 'precision': 0, 'index': 99, 'type': 'time', 'state_class': 'measurement'},
    "econ_rule_3_volt": {'address': 8731, 'name': 'ECO3_Volt', 'precision': 1, 'index': 1, 'unit': 'V', 'device_class': 'voltage', 'state_class': 'measurement'},
    ...
    "econ_rule_4_start_time": {'address': 8736, 'name': 'ECO4_start_time', 'precision': 0, 'index': 99, 'type': 'time', 'state_class': 'measurement'},
    "econ_rule_4_stop_time": {'address': 8737, 'name': 'ECO4_stop_time', 'precision': 0, 'index': 99, 'type': 'time', 'state_class': 'measurement'},
    "econ_rule_4_volt": {'address': 8738, 'name': 'ECO4_Volt', 'precision': 1, 'index': 1, 'unit': 'V', 'device_class': 'voltage', 'state_class': 'measurement'},
    ...
    "econ_rule_5_start_time": {'address': 8743, 'name': 'ECO5_start_time', 'precision': 0, 'index': 99, 'type': 'time', 'state_class': 'measurement'},
    "econ_rule_5_stop_time": {'address': 8744, 'name': 'ECO5_stop_time', 'precision': 0, 'index': 99, 'type': 'time', 'state_class': 'measurement'},
    "econ_rule_5_volt": {'address': 8745, 'name': 'ECO5_Volt', 'precision': 1, 'index': 1, 'unit': 'V', 'device_class': 'voltage', 'state_class': 'measurement'},
    ...
    "econ_rule_6_start_time": {'address': 8750, 'name': 'ECO6_start_time', 'precision': 0, 'index': 99, 'type': 'time', 'state_class': 'measurement'},
    "econ_rule_6_stop_time": {'address': 8751, 'name': 'ECO6_stop_time', 'precision': 0, 'index': 99, 'type': 'time', 'state_class': 'measurement'},
    "econ_rule_6_volt": {'address': 8752, 'name': 'ECO6_Volt', 'precision': 1, 'index': 1, 'unit': 'V', 'device_class': 'voltage', 'state_class': 'measurement'},
