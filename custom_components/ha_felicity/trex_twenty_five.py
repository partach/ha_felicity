...
_REGISTERS_TREX_TWENTY_FIVE = {
    ...
    "phase_a_home_load_power": {'address': 4384, 'name': 'Phase A home load power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    "phase_b_home_load_power": {'address': 4385, 'name': 'Phase B home load power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    "phase_c_home_load_power": {'address': 4386, 'name': 'Phase C home load power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    "pv1_power": {'address': 4392, 'name': 'PV1 power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    "pv2_power": {'address': 4393, 'name': 'PV2 power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    "pv3_power": {'address': 4394, 'name': 'PV3 power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    "pv4_power": {'address': 4395, 'name': 'PV4 power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    ...
    "bat1_power": {'address': 4401, 'name': 'Bat1 power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    "bat2_current": {'address': 4402, 'name': 'Bat2 current', 'precision': 1, 'index': 8, 'unit': 'A', 'device_class': 'current', 'state_class': 'measurement'},
    "bat2_power": {'address': 4403, 'name': 'Bat2 power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    ...
    "phase_a_generator_active_power": {'address': 4464, 'name': 'Phase A generator active power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    "phase_b_generator_active_power": {'address': 4465, 'name': 'Phase B generator active power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    "phase_c_generator_active_power": {'address': 4466, 'name': 'Phase C generator active power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    "phase_a_grid_active_power": {'address': 4467, 'name': 'Phase A grid active power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    "phase_b_grid_active_power": {'address': 4468, 'name': 'Phase B grid active power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    "phase_c_grid_active_power": {'address': 4469, 'name': 'Phase C grid active power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    "phase_a_inverter_active_power": {'address': 4470, 'name': 'Phase A inverter active power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    "phase_b_inverter_active_power": {'address': 4471, 'name': 'Phase B inverter active power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    "phase_c_inverter_active_power": {'address': 4472, 'name': 'Phase C inverter active power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    "phase_a_load_active_power": {'address': 4473, 'name': 'Phase A load active power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    "phase_b_load_active_power": {'address': 4474, 'name': 'Phase B load active power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    "phase_c_load_active_power": {'address': 4475, 'name': 'Phase C load active power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    "phase_a_load_apparent_power": {'address': 4476, 'name': 'Phase A load apparent power', 'precision': 1, 'index': 9, 'unit': 'kVA', 'device_class': 'apparent_power', 'state_class': 'measurement'},  # Custom: apparent_power
    "phase_b_load_apparent_power": {'address': 4477, 'name': 'Phase B load apparent power', 'precision': 1, 'index': 9, 'unit': 'kVA', 'device_class': 'apparent_power', 'state_class': 'measurement'},
    "phase_c_load_apparent_power": {'address': 4478, 'name': 'Phase C load apparent power', 'precision': 1, 'index': 9, 'unit': 'kVA', 'device_class': 'apparent_power', 'state_class': 'measurement'},
    ...
    "phase_a_ct_active_power": {'address': 4482, 'name': 'Phase A CT active power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    "phase_b_ct_active_power": {'address': 4483, 'name': 'Phase B CT active power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    "phase_c_ct_active_power": {'address': 4484, 'name': 'Phase C CT active power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    ...
    "total_generator_power": {'address': 4498, 'name': 'Total generator power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    "total_load_power": {'address': 4499, 'name': 'Total load power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    "total_grid_power": {'address': 4500, 'name': 'Total grid power', 'precision': 1, 'index': 9, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement'},
    ...
    "grid_peak_shaving_power": {'address': 8521, 'name': 'Grid Peak Shaving Power', 'precision': 1, 'index': 1, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement', 'type': 'number', 'min': 0, 'max': 25},
...
#    "grid3ufvalue": {'address': 8702, 'name': 'Grid3UFValue', 'precision': 2, 'index': 2, 'unit': 'Hz', 'device_class': 'frequency', 'state_class': 'measurement'},
    "econ_rule_1_sell_enable": {'address': 8703, 'name': 'ECO1_sell_enable', 'precision': 0, 'index': 0, 'state_class': 'measurement', 'type': 'select', 'options': ['Disabled', 'Enabled']},
    "econ_rule_2_sell_enable": {'address': 8704, 'name': 'ECO2_sell_enable', 'precision': 0, 'index': 0, 'state_class': 'measurement', 'type': 'select', 'options': ['Disabled', 'Enabled']},
    "econ_rule_3_sell_enable": {'address': 8705, 'name': 'ECO3_sell_enable', 'precision': 0, 'index': 0, 'state_class': 'measurement', 'type': 'select', 'options': ['Disabled', 'Enabled']},
    "econ_rule_4_sell_enable": {'address': 8706, 'name': 'ECO4_sell_enable', 'precision': 0, 'index': 0, 'state_class': 'measurement', 'type': 'select', 'options': ['Disabled', 'Enabled']},
    "econ_rule_5_sell_enable": {'address': 8707, 'name': 'ECO5_sell_enable', 'precision': 0, 'index': 0, 'state_class': 'measurement', 'type': 'select', 'options': ['Disabled', 'Enabled']},
    "econ_rule_6_sell_enable": {'address': 8708, 'name': 'ECO6_sell_enable', 'precision': 0, 'index': 0, 'state_class': 'measurement', 'type': 'select', 'options': ['Disabled', 'Enabled']},
    ...
    "eco_effectiveweek": {'address': 8712, 'name': 'ECO_EffectiveWeek', 'precision': 0, 'index': 0, 'state_class': 'measurement', 'type': 'select_multi', 'options': ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday','Every day']},
    ...
    "econ_rule_1_voltage": {'address': 8717, 'name': 'ECO1_Volt', 'precision': 1, 'index': 1, 'unit': 'V', 'device_class': 'voltage', 'state_class': 'measurement', 'type': 'number', 'min': 48, 'max': 500},
    "econ_rule_1_soc": {'address': 8718, 'name': 'ECO1_SOC', 'precision': 0, 'index': 0, 'unit': '%', 'device_class': 'battery', 'state_class': 'measurement', 'type': 'number', 'min': 0, 'max': 100},
    "econ_rule_1_power": {'address': 8719, 'name': 'ECO1_Power', 'precision': 1, 'index': 1, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement', 'type': 'number', 'min': 0, 'max': 25},
    ...
    "econ_rule_2_voltage": {'address': 8724, 'name': 'ECO2_Volt', 'precision': 1, 'index': 1, 'unit': 'V', 'device_class': 'voltage', 'state_class': 'measurement', 'type': 'number', 'min': 48, 'max': 500},
    "econ_rule_2_soc": {'address': 8725, 'name': 'ECO2_SOC', 'precision': 0, 'index': 0, 'unit': '%', 'device_class': 'battery', 'state_class': 'measurement', 'type': 'number', 'min': 0, 'max': 100},
    "econ_rule_2_power": {'address': 8726, 'name': 'ECO2_Power', 'precision': 1, 'index': 1, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement', 'type': 'number', 'min': 0, 'max': 25},
    ...
    "econ_rule_3_voltage": {'address': 8731, 'name': 'ECO3_Volt', 'precision': 1, 'index': 1, 'unit': 'V', 'device_class': 'voltage', 'state_class': 'measurement', 'type': 'number', 'min': 48, 'max': 500},
    "econ_rule_3_soc": {'address': 8732, 'name': 'ECO3_SOC', 'precision': 0, 'index': 0, 'unit': '%', 'device_class': 'battery', 'state_class': 'measurement', 'type': 'number', 'min': 0, 'max': 100},
    "econ_rule_3_power": {'address': 8733, 'name': 'ECO3_Power', 'precision': 1, 'index': 1, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement', 'type': 'number', 'min': 0, 'max': 25},
    ...
    "econ_rule_4_voltage": {'address': 8738, 'name': 'ECO4_Volt', 'precision': 1, 'index': 1, 'unit': 'V', 'device_class': 'voltage', 'state_class': 'measurement', 'type': 'number', 'min': 48, 'max': 500},
    "econ_rule_4_soc": {'address': 8739, 'name': 'ECO4_SOC', 'precision': 0, 'index': 0, 'unit': '%', 'device_class': 'battery', 'state_class': 'measurement', 'type': 'number', 'min': 0, 'max': 100},
    "econ_rule_4_power": {'address': 8740, 'name': 'ECO4_Power', 'precision': 1, 'index': 1, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement', 'type': 'number', 'min': 0, 'max': 25},
    ...
    "econ_rule_6_voltage": {'address': 8752, 'name': 'ECO6_Volt', 'precision': 1, 'index': 1, 'unit': 'V', 'device_class': 'voltage', 'state_class': 'measurement', 'type': 'number', 'min': 48, 'max': 500},
    "econ_rule_6_soc": {'address': 8753, 'name': 'ECO6_SOC', 'precision': 0, 'index': 0, 'unit': '%', 'device_class': 'battery', 'state_class': 'measurement', 'type': 'number', 'min': 0, 'max': 100},
    "econ_rule_6_power": {'address': 8754, 'name': 'ECO6_Power', 'precision': 1, 'index': 1, 'unit': 'kW', 'device_class': 'power', 'state_class': 'measurement', 'type': 'number', 'min': 0, 'max': 25},
    "econ_rule_pv": {'address': 8755, 'name': 'ECO_PV_Off', 'precision': 0, 'index': 0, 'state_class': 'measurement', 'type': 'select_multi', 'options': ['Eco_1_PV_Off', 'Eco_2_PV_Off', 'Eco_3_PV_Off', 'Eco_4_PV_Off', 'Eco_5_PV_Off', 'Eco_6_PV_Off']},
    "smartloadtimeenable": {'address': 8756, 'name': 'SmartLoadTimeEnable', 'precision': 0, 'index': 0, 'type': 'select', 'state_class': 'measurement', 'options': ['Disabled', 'Enabled']},
    "smartloadstarttime": {'address': 8757, 'name': 'SmartLoadStartTime', 'precision': 0, 'index': 0, 'type': 'time8bit', 'state_class': 'measurement'},
    "smartloadstoptime": {'address': 8758, 'name': 'SmartLoadStopTime', 'precision': 0, 'index': 0, 'type': 'time8bit', 'state_class': 'measurement'},
...
REGISTER_SETS_TREX_TWENTY_FIVE = {
    ...
    "full": _REGISTERS_TREX_TWENTY_FIVE,
}
