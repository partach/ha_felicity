...
_REGISTERS_TREX_TWENTY_FIVE = {
    ...
    "econ_rule_2_sell_enable": {'address': 8704, 'name': 'ECO1_sell_enable', 'precision': 0, 'index': 0, 'state_class': 'measurement', 'type': 'select', 'options': ['Disabled', 'Enabled']},
    "econ_rule_3_sell_enable": {'address': 8705, 'name': 'ECO1_sell_enable', 'precision': 0, 'index': 0, 'state_class': 'measurement', 'type': 'select', 'options': ['Disabled', 'Enabled']},
    "econ_rule_4_sell_enable": {'address': 8706, 'name': 'ECO1_sell_enable', 'precision': 0, 'index': 0, 'state_class': 'measurement', 'type': 'select', 'options': ['Disabled', 'Enabled']},
    "econ_rule_5_sell_enable": {'address': 8707, 'name': 'ECO1_sell_enable', 'precision': 0, 'index': 0, 'state_class': 'measurement', 'type': 'select', 'options': ['Disabled', 'Enabled']},
    "econ_rule_6_sell_enable": {'address': 8708, 'name': 'ECO1_sell_enable', 'precision': 0, 'index': 0, 'state_class': 'measurement', 'type': 'select', 'options': ['Disabled', 'Enabled']},
