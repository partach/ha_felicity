...
_COMBINED_REGISTERS_TREX_FIVE = {
    "pv_total_power": {
        "sources": ["pv_input_power", "pv2_input_power"],
    ...
    "ac_active_power": {
        "sources": ["invert_active_power"],
        "calc": lambda p1: (p1 or 0),
        "unit": "W",
        "device_class": "power",
        "state_class": "measurement",
...
REGISTER_SETS_TREX_FIVE = {
    "basic": {
        key: info
        for key, info in _REGISTERS_TREX_FIVE.items()
        if key in {
            "ac_active_power",
            "pv_total_power",
   ...
   #         "ac_input_voltage_l3",
    ...
    "full": _REGISTERS_TREX_FIVE,  # All – including secondary if any (or filter here too if you want)
}
