...
_REGISTER_GROUPS = [
    ...
    {'start': 4360, 'count': 33, 'keys': [
       ...
       'ac_input_current_l3', 'ac_input_frequency_l3', 'ac_input_power_l3', 'total_ac_input_power'
    ]},
    ...
    {'start': 4476, 'count': 11, 'keys': [
       'ac_generated_energy_day', 'battery_charged_energy_total_high', 'battery_charged_energy_total_low',
       'battery_charged_energy_year',  'battery_charged_energy_month', 'battery_charged_energy_day',
       'battery_discharged_energy_total_high', 'battery_discharged_energy_total_low', 'battery_discharged_energy_year',
       'battery_discharged_energy_month', 'battery_discharged_energy_day'
    ]},
