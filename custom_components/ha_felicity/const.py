...
_REGISTERS = {
    ...
    "ac_output_voltage_l3_secondary": {"address": 4550, "name": "Ac Output Voltage L3", "unit": "V secondary", "device_class": "voltage", "state_class": "measurement", "precision": 1, "index": 1},
